...
## Concepto
Un arreglo, también conocido como vector o array, es una estructura de datos homogénea y estática que almacena una colección de elementos del mismo tipo bajo un único nombre común. Se considera estática porque su tamaño debe ser definido al momento de la declaración y no puede cambiar durante la ejecución del programa. Cada elemento dentro del arreglo se almacena de forma consecutiva en la memoria del ordenador y se accede a él de manera directa utilizando un número entero denominado índice, el cual en la gran mayoría de los lenguajes de programación comienza estrictamente en la posición cero.
...
<img width="213" height="22" alt="image" src="https://github.com/user-attachments/assets/c6dbe0f5-74c6-41c9-897a-060c0ced4e50" />
